...
public class ApiClient {
    ...
    public ApiClient() {
        ...
        authentications.put("Token Authentication", new ApiKeyAuth("header", "Authorization"));
    ...
    private void init() {
        ...
        setUserAgent("ionos-cloud-sdk-python/5.2.6");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://api.ionos.com/cloudapi/v5
